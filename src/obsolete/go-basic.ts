...
export async function main(ns: NS): Promise<void> {
  ...
  while (true) {
    ...
    do {
      ...
      allocate_threads(best.grow_threads, 'worker/weak1.js', best.server, best.grow_delay);
      allocate_threads(best.hack_threads, 'worker/hack1.js', best.server, best.hack_delay);
      allocate_threads(best.weaken_2nd_threads, 'worker/weak1.js', best.server, best.weaken_2nd_delay);
      allocate_threads(best.weaken_1st_threads, 'worker/weak1.js', best.server, best.weaken_1st_delay);
